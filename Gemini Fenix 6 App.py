...
def _render_join_qr(cfg):
    ...
    st.markdown(
        ...
        "margin:0 0 8px;}"
        ".tv-deals-cards{display:flex;flex-wrap:wrap;gap:14px;justify-content:center;}"
        ".tv-prod-card{width:168px;background:#ffffff;border-radius:14px;overflow:hidden;"
        "box-shadow:0 6px 18px rgba(0,0,0,.18);text-decoration:none;color:#111;display:block;}"
        ".tv-prod-img{height:104px;background-size:cover;background-position:center;}"
        ".tv-prod-noimg{display:flex;align-items:center;justify-content:center;"
        "font-size:40px;background:#eef2f6;}"
        ".tv-prod-title{padding:7px 10px 1px;font-weight:700;font-size:15px;line-height:1.15;}"
        ".tv-prod-price{padding:0 10px 9px;color:#0a7;font-weight:800;font-size:16px;}"
        "</style>"
